...
import 'package:motionminglee/Patient/components/bottom_navigation_bar.dart';
...
class LoginPagePatient extends StatelessWidget {
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      FadeInUp(duration: const Duration(milliseconds: 1600),
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>BottomNavigationBarOzelPatient()));
                        },
                        height: 50,
